Document.addEventListener('DOMContentLoaded', () => {
    ...
    const routines = {
        '1': {
            ...
            branches: {
                ...
                'kh': {
                    name: 'খ শাখা',
                    routine: null // "Routine update message"
                },
                'g': {
                    name: 'গ শাখা',
                    routine: null // "Routine update message"
    ...
    function handleSemesterClick(e) {
        ...
        if (semesterData.branches) {
            ...
            // Dynamically create branch items
            for (const branchId in semesterData.branches) {
                const branchItem = document.createElement('div');
                branchItem.className = 'branch-item';
                branchItem.dataset.branch = branchId;
                branchItem.textContent = semesterData.branches[branchId].name;
                branchNav.appendChild(branchItem);
            }
